  ...
  return (
    <Layout>
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold mb-6">Полигон — задания</h1>
        <p className="text-gray-600 mb-6">Здесь вы можете выполнять практические задания по кибербезопасности.</p>
        ...
        {loading ? (
          ...
          <p className="text-gray-500 text-center py-8">Нет доступных заданий</p>
        ) : (
            ...
            {tasks.map((task) => (
              <div key={task.id} className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-xs text-gray-400">Автор: {task.creator.fullName}</span>
                  <button
