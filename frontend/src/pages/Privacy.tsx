    ...
    <Layout>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow p-6 space-y-4 text-gray-700">
          ...
          <p>
            Мы собираем информацию, которую вы предоставляете при регистрации: имя, адрес электронной почты, номер группы, а также данные о выполненных заданиях и активности на платформе.
          </p>
