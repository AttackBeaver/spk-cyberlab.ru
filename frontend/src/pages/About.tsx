  ...
  return (
    <Layout>
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-6">О платформе</h1>

        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <h2 className="text-xl font-semibold mb-4">Добро пожаловать в SPK CyberLab!</h2>
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <h2 className="text-xl font-semibold mb-4">О Сибирском профессиональном колледже</h2>
          <p className="text-gray-700 mb-4">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h2 className="text-xl font-semibold mb-4">Что вы найдёте на платформе</h2>
